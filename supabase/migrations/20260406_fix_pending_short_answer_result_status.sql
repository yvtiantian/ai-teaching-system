-- =====================================================
-- 修复学生成绩页中“等待 AI 批改的简答题被显示为回答有误”
-- 目标：
-- 1. 未作答题仍按错误展示
-- 2. 已作答但仍处于 submitted/ai_grading 的简答题，is_correct 返回 NULL
-- 3. 避免 student_get_result 将待 AI 的简答题通过 COALESCE 压成 false
-- =====================================================
...
COMMENT ON FUNCTION public.student_get_result(UUID) IS '学生查看成绩结果（等待 AI 的简答题不提前标错）';
